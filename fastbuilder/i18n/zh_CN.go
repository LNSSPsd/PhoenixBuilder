...
var I18nDict_zh_CN map[uint16]string = map[uint16]string{
	...
	BDump_FileNotSigned:                 "文件未签名，但别担心，通常都可以导入",
	...
	Copyright_Notice_Bouldev:            "版权所有 (c) FastBuilder DevGroup, Bouldev 2023",
